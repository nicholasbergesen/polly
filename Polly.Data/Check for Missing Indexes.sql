...
OPTION (RECOMPILE);
 ...
 CREATE INDEX [IX_PriceHistory_DiscountPercentage] ON [PollyDb].[dbo].[PriceHistory] ([DiscountPercentage]) INCLUDE ([Id], [Price], [TimeStamp], [ProductId], [OriginalPrice], [DiscountAmount], [PreviousPriceHistoryId], [PriceChangeAmount], [PriceChangePercent])